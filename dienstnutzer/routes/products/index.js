...
// Ressource products/bestrating (GET)  !!!!! ANWENDUNGSLOGIK !!!!!!!
/* Zeigt die bestbewertesten Produkte mit den Produktinformationen an */
router.get("/:bestrating",function(req,res){
    request.get("http://localhost:3001/reviews",function(error,response,body){ // Fragt die Produkte  mit der angegebenen ID des Dienstgebers an.
       var content = body;
